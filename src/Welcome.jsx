...
import mflixlogo from "./resources/Mflix_Brand_Logo1.png";
...
class NavBar extends React.Component {
    render() {
        return(
            <nav style={{backgroundColor:"#3f053a", color:"white", display:"inline-block"}}>
                <img src={mflixlogo} alt="demo pic" style={{width:"150px", height:"80px"}}/>
                <button style={{backgroundColor:"#db4dce", color:"white", display:"inline-block", width:"100px", height:"40px",borderRadius:"5px",position:"absolute", margin:"20px", right:"20px"}}><b>Sign In</b></button>    
            </nav>
        )
    }
}
    ...
    render() {
        return(
            <div>
                ...
                <center style={{zIndex:"0", position:"absolute", top:"250px", left:"15%"}}>
                    ...
                    <input type="email" placeholder="Enter your email address" style={{width:"400px", height:"40px", borderRadius:"10px"}}/>
                    <button style={{backgroundColor:"#db4dce", color:"white", display:"inline-block", width:"100px", height:"40px",borderRadius:"5px"}}><b>See Plans</b></button>
                </center>
            </div>
        )
    }
...
class Slide extends React.Component {
    render() {
        return(
            <div style={{backgroundColor:"black", display:"inline-block", height:"350px"}}>
    ...
    render() {
        return(
            <div style={{backgroundColor:"black", display:"inline-block", height:"350px"}}>
                ...
                <p style={{color:"white", position:"absolute", padding:"100px", display:"inline-block", fontSize:"30px", fontFamily: "Netflix Sans,Helvetica Neue,Helvetica,Arial,sans-serif"}}>
                    Create Profiles for Kids and set<br/> them free to play and explore in<br/> entertainment made for them
                </p>
            </div>
        )
    }
    ...
    render() {
        return(
            <div style={{backgroundColor:"black"}}>
                ...
                <button>
                    2. What plans can I choose?
                </button>
                <button>
                    3. How many devices can I use this on?
                </button>
                <button>
